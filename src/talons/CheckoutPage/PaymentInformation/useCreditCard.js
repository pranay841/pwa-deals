...
export const useCreditCard = props => {
    ...
    const shippingAddressCountry = shippingAddressData
        ? shippingAddressData.cart.shippingAddresses[0] ? shippingAddressData.cart.shippingAddresses[0].country.code:  DEFAULT_COUNTRY_CODE
        : DEFAULT_COUNTRY_CODE;

    const isBillingAddressSame = formState.values.isBillingAddressSame ? formState.values.isBillingAddressSame : false;
