...
import CreateAccount from '@magento/venia-ui/lib/components/CheckoutPage/OrderConfirmationPage/createAccount.js';
...
const OrderConfirmationPage = props => {
    ...
    const talonPropsCart = useCartPage();
    const {
        cartItems,
    } = talonPropsCart;
    ...
    if(isShippingRequired){
        streetRows = street.map((row, index) => {
            return (
    ...
    return (
        <div className={classes.root}>
            ...
            <div className={classes.mainContainer}>
                ...
                {isShippingRequired &&(<><div className={classes.shippingInfoHeading}>
                    <FormattedMessage
